...
function Footer2() {
  ...
  return (
    <>
      <div className="w-full flex flex-col justify-center p-8 py-14 bg-footer text-white">
        <div className="md:w-3/4 mx-auto text-center flex justify-center mb-4 md:flex-row flex-col-reverse  rounded-md">
                ...
                <p className="pb-4">
                  {
                    rpdata?.simpleWidgets?.[3]?.activo ?
                      ...
                      :
                      rpdata?.dbAbout?.[0].text.substring(0, 282)
                  }
                </p>
              </div>
            </div>
