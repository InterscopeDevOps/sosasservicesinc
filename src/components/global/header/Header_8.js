...
function Header_5() {
  ...
  return (
    <div className="relative w-full z-[10] md:py-0 py-2">
      <header className="">
        <ScrollProgressBar />
        ...
        {/* modo desktop barra */}
        <div className="md:block hidden ">
          <nav className="w-4/5 mx-auto flex flex-wrap items-center justify-between shadow-2xl rounded-lg relative bg2 md:mb-[-20px]">
            ...
            >
              ...
              <div className="ml-4">
                <a href={`tel:+1${rpdata?.dbPrincipal?.phones?.[0].phone}`}>
                  <FiPhoneCall className="bg-2 text-white p-4 text-[70px] rounded-r-lg" />
                </a>
              </div>
            </div>
          </nav>
          ...
          <nav className="side-slide z-10">
            ...
            <div>
              <img
                src={rpdata?.dbPrincipal?.logo}
                alt="Company Logo"
                className="w-[80%] mb-8 bg-white rounded-lg mx-auto"
