  ...
  return (
    <div className="relative z-50 w-full">
      <header className="md:block hidden">
        <ScrollProgressBar />
        <div className="bg-2 p-2 text-white">
        ...
        <div>
          <nav className="w-[100%] mx-auto flex flex-wrap items-center justify-between py-2 md:py-2 md:px-32 shadow-2xl  p-4 relative bg2">
              ...
              <ul className="pt-4 text-base text-black md:flex md:justify-between md:pt-0 p-4">
                {Navigation.map((item, index) => {
                  return (
                    <li
                      key={index}
                      className="md:py-2 md:px-4 py-2 px-4 rounded-sm text-white bg-list-menu"
                    >
                      <NavLink
                      ...
                      {item.child ? (
                        subMenu ? (
                          <ul className="bg-[#AE1515] rounded-sm w-[200px] text-black absolute mt-10">
