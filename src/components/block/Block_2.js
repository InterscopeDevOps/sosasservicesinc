...
const BlockTwo = ({ title, text, listsAbout, listsServices, image, sloganPrincipal }) => {
    ...
    return (
        <div className='bgContent-2 pt-28 pb-40 md:py-40'>
            <div className='w-[90%] md:w-4/5 mx-auto block lg:flex justify-center'>
                <div className='w-full flex justify-center lg:block lg:w-[30%]'>
                    <div
                        className='relative w-full h-[300px] md:w-[500px] md:h-[500px] overflow-hidden rounded-bl-[50%] rounded-tr-[50%]'
                        style={{
                ...
                <div className='w-full lg:w-[60%] -my-20 bg-white rounded-br-[50%] rounded-tl-[50%]'>
